...
class Q_Trainer(object):
    ...
    def __init__(self, params):
        ...
        self.params['agent_class'] = DDQNAgent
...
def main():
    ...
    parser.add_argument(
        '--env_name',
        default='MsPacman-v0',
        choices=('PongNoFrameskip-v4', 'LunarLander-v3', 'MsPacman-v0', 'MiniGrid-Empty-5x5-v0', 'CartPole-v0', 'MountainCar-v0')
    )
